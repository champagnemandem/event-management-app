...
var ContactService = /** @class */ (function () {
    function ContactService(errorService, service) {
        this.errorService = errorService;
        this.service = service;
    }
    ContactService.prototype.getContact = function () {
        var _this = this;
        return this.service.get(globalvariables_1.globalVariables.API_URL + '/services/apexrest/v1/contact')
    ...
    ContactService.prototype.updateContact = function (contact) {
        var _this = this;
        return this.service.put(globalvariables_1.globalVariables.API_URL + '/services/apexrest/v1/contact/update', JSON.stringify(contact))
            .map(function (response) { return response.json(); })
            .catch(function (err) { return _this.errorService.handleError(err); });
    };
